...
$cliente = new Cliente();
$DAOCliente = new DAOCliente();/*conecção com o BD*/
if (isset($_POST['botao'])) {
  $cliente->setNome( $_nome = $_POST['nome']);
  $cliente->setCpf($_cpf = $_POST['cpf']);
  $cliente->setTelefone($_telefone = $_POST['telefone']);
  $cliente->setEmail($_email = $_POST['email']);
  $cliente->setendereco($_endereco = $_POST['endereco']);
