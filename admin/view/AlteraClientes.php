...
if (isset($_GET['acao']) && ($_GET['acao']== 'alterar' )) { 
  ...
  $cliente->setId($_POST['idclientes']);
...
<div class="mb-3">
    <div  class="form-text">Digite o ID do cliente.</div>
    <input type="text" class="form-control"  name="idclientes" value="<?php echo $ids; ?>" >
  </div>
  <div class="mb-3">
  ...
  <div  class="form-text">Digite o email do Cliente.</div>
    <input type="text" class="form-control" name="email" value="<?php echo $linhas['email']; ?>">
  </div>
  <div class="mb-3">
