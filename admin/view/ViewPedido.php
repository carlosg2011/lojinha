...
include_once '../model/Pedidoclasse.PHP';
$pedido = new Pedido();
...
$pedido->setquantidadeEstoque($_POST["quantidadeEstoque"]);
...
<div id="nome" class="form-text">Digite o nome do fornecedor.</div>
</div>
<div class="mb-3">
<label for="exampleInputPassword1" class="form-label" >produto</label>
<input type="text" class="form-control" id="exampleInputPassword1" name="produto">
<div id="nome" class="form-text">Digite o produto</div>

</div>
<div class="mb-3">
<label for="exampleInputPassword1" class="form-label">quantidadeEstoque</label>

<input type="text" class="form-control" id="exampleInputPassword1" name="quantidadeEstoque">
<div id="nome" class="form-text">Digite o quantidadeEstoque</div>

</div>
<div class="mb-3">
<label for="exampleInputPassword1" class="form-label">dataPedido</label>

<input type="text" class="form-control" id="exampleInputPassword1" name="dataPedido">
<div id="nome" class="form-text">Digite o dataPedido.</div>
...
<div id="nome" class="form-text">Digite o total.</div>
