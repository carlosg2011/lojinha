...
include_once '../model/ProdutosClasse.PHP';
$Produtos = new Produtos();

if(isset($_POST["enviar"]))
{
$Produtos->setDescricao($_POST["descricao"]);
$Produtos->setPrecoCompra($_POST["compra"]);
$Produtos->setPrecoVenda($_POST["venda"]);
$Produtos->setEstoque($_POST["estoque"]);
}
?>
<!DOCTYPE HTML>
<html lang="pt-br">   
...
<div id="nome" class="form-text">Digite a descricao do produto.</div>
</div>
<div class="mb-3">
<label for="exampleInputPassword1" class="form-label" >Preco de Compra</label>
<input type="text" class="form-control" id="exampleInputPassword1" name="compra">
<div id="nome" class="form-text">Digite o valor de compra.</div>

</div>
<div class="mb-3">
<label for="exampleInputPassword1" class="form-label">Preco Venda</label>

<input type="email" class="form-control" id="exampleInputPassword1" name="venda">
<div id="nome" class="form-text">Digite o preco de venda.</div>
...
<div id="nome" class="form-text">Digite a quantidade no estoque.</div>
